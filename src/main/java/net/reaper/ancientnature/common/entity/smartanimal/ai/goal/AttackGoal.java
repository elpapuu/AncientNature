...
public class AttackGoal extends MeleeAttackGoal {
    private final SmartAnimatedAnimal animal;
    private final int attackDelay;
    private final int animationLength;
    private int ticksUntilNextAttack;
    private boolean shouldCountTillNextAttack = false;

    public AttackGoal(SmartAnimatedAnimal pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen,int attackDelay, int attackAnimationLength) {
    ...
    public boolean canUse() {
        return super.canUse()&&animal.canAttack();
    }
