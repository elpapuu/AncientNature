...
public class PickupFoodGoal extends Goal {
    protected final TRexEntity mob;
    ...
    public PickupFoodGoal(TRexEntity pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen, int eatDelay, int animationLength) {
        this.mob = pMob;
