 ...
 * @author Author
 */
public class anomalocarisAnimation {
	public static final AnimationDefinition animation.anomalocaris.swim = AnimationDefinition.Builder.withLength(1.5F).looping()
	...
	public static final AnimationDefinition animation.anomalocaris.eat = AnimationDefinition.Builder.withLength(1.5F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(-0.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
	...
	public static final AnimationDefinition animation.anomalocaris.attack = AnimationDefinition.Builder.withLength(0.25F)
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition animation.anomalocaris.flop = AnimationDefinition.Builder.withLength(0.0833F).looping()
