 ...
 * @author Author
 */
public class ArandaspisBabyAnimations {
	public static final AnimationDefinition ANIMATION_ARANDASPISBABY_FLOP = AnimationDefinition.Builder.withLength(0.5F).looping()
	...
	public static final AnimationDefinition ANIMATION_ARANDASPISBABY_SWIM = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition ANIMATION_ARANDASPIS_BABY_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION, 
	...
	public static final AnimationDefinition ANIMATION_ARANDASPIS_BABY_SPRINT = AnimationDefinition.Builder.withLength(0.5F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
