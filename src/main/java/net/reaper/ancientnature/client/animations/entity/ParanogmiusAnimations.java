...
public class ParanogmiusAnimations {
	public static final AnimationDefinition PARANOGMIUS_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
		.addAnimation("dorsal", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.625F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("finleft", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(5.0F, -75.9985F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, -65.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(-5.6222F, -73.9602F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("endtail", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(-0.0006F, -0.0559F, -0.1551F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(-0.0006F, -0.0559F, -0.1551F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("tailfin", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.01F, 0.3194F, 2.6453F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.6667F, KeyframeAnimations.degreeVec(0.0019F, -0.0558F, -2.6551F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.3333F, KeyframeAnimations.degreeVec(0.0019F, -0.0558F, -2.6551F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.01F, 0.3194F, 2.6453F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.build();
	...
	public static final AnimationDefinition PARANOGMIUS_SWIM = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.246F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("mouth", new AnimationChannel(AnimationChannel.Targets.SCALE,
			new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.045F, 1.0F, 1.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("dorsal", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("finleft", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -85.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(5.0F, -75.9985F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, -65.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-5.6222F, -73.9602F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition PARANOGMIUS_SPRINT = AnimationDefinition.Builder.withLength(0.3333F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.2187F, -4.9952F, -2.5095F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.3333F, KeyframeAnimations.degreeVec(0.246F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -2.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("finleft", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, -85.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.0833F, KeyframeAnimations.degreeVec(5.0F, -75.9985F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.1667F, KeyframeAnimations.degreeVec(0.0F, -65.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(-5.6222F, -73.9602F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.3333F, KeyframeAnimations.degreeVec(0.0F, -85.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("finright", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 85.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.0833F, KeyframeAnimations.degreeVec(5.0F, 75.9985F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition PARANOGMIUS_FLOP = AnimationDefinition.Builder.withLength(0.5F).looping()
		.addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, -5.9375F, 90.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.375F, KeyframeAnimations.degreeVec(0.0F, 10.0F, 90.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("mouth", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			...
			new Keyframe(0.25F, KeyframeAnimations.scaleVec(1.2F, 1.1F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("jaw", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.4167F, KeyframeAnimations.degreeVec(18.33F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("dorsal", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 18.75F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.375F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -21.25F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("endtail", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.125F, KeyframeAnimations.degreeVec(0.0F, -8.4375F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
