...
public class ModArcheologyLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
            LootTable.Builder builder = LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemRandomChanceCondition.randomChance(0.894f)).add(LootItem.lootTableItem(ModItems.MUDDY_PERMIAN_FOSSIL.get()).setWeight(6)));
