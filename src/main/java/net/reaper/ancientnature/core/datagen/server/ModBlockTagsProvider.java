...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.DEEPSLATE_AMBER.get(), ModBlocks.DEEPSLATE_CAMBRIAN_FOSSIL.get(), ModBlocks.DEEPSLATE_DEVONIAN_FOSSIL.get(), ModBlocks.DEEPSLATE_CARBONIFEROUS.get(), ModBlocks.STONE_PERMIAN_FOSSIL.get());
