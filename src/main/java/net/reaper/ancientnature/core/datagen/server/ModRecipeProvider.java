...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        BrushRecipeBuilder.builder(ModItems.PARANOGMIUS_FOSSIL.get()).probability(0.96f).input(ModItems.CRETACEOUS_FOSSIL.get()).build(pWriter);
        ...
        BrushRecipeBuilder.builder(ModItems.DODO_FOSSIL.get()).probability(1.0f).input(ModItems.QUATERNARY_FOSSIL.get()).build(pWriter);
        BrushRecipeBuilder.builder(ModItems.LYTHRONAX_FOSSIL.get()).probability(1.0f).input(ModItems.CRETACEOUS_FOSSIL.get()).build(pWriter);
