...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        tag(ModTags.Items.FOSSILS).add(ModItems.ANOMALOCARIS_FOSSIL.get(), ModItems.CAMBRIAN_FOSSIL.get(), ModItems.CARBONIFEROUS_FOSSIL.get(), ModItems.DEEPSLATE_PERMIAN_FOSSIL.get(), ModItems.STONE_PERMIAN_FOSSIL.get(), ModItems.DEVONIAN_FOSSIL.get(), ModItems.LYTHRONAX_FOSSIL.get());
